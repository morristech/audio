/**
 * @file
 * The implementation of the org.alljoyn.Stream.Port.ImageSink interface.
 */
...
#ifndef _IMAGESINKOBJECT_H
#define _IMAGESINKOBJECT_H

#ifndef __cplusplus
#error Only include ImageSinkObject.h in C++ code.
#endif
...
/**
 * The object that implements the org.alljoyn.Stream.Port.ImageSink interface.
 */
class ImageSinkObject : public PortObject {
  ...
  public:
     ...
     */
    ImageSinkObject(ajn::BusAttachment* bus, const char* path, StreamObject* stream);
  ...
  private:
    ...
    void ImageDataSignalHandler(const ajn::InterfaceDescription::Member* member,
