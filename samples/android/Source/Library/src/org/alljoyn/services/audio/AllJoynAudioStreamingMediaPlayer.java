...
public class AllJoynAudioStreamingMediaPlayer extends MediaPlayer {
	private static final String TAG = "AllJoynAudioStreamingMediaPlayer";
	
	/* Handler used to make calls to AllJoyn methods. See onCreate(). */
    private Handler mBusHandler;
    private AllJoynAudioStreamingListener mListener;
    ...
    public AllJoynAudioStreamingMediaPlayer() {
    ...
    public void setAllJoynAudioStreamingListener(AllJoynAudioStreamingListener listener) {
    	mListener = listener;
    }
