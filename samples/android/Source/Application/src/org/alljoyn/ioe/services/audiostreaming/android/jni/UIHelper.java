...
package org.alljoyn.ioe.services.audiostreaming.android.jni;
...
public class UIHelper {
    ...
    private AllJoynAudioStreamingMediaPlayer mMediaPlayer;
    ...
    public UIHelper(Activity activity) {
    	...
    	mMediaPlayer = new AllJoynAudioStreamingMediaPlayer();
    	mSinkSelectDialog = new SinkSelectDialog();
    	mSinkSelectDialog.SetActivity(activity);
    }
    
    public void init() {
    	mMediaPlayer.setAllJoynAudioStreamingListener(new AllJoynAudioStreamingListener() {
			@Override
